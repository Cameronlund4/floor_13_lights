...
leftProvider = CloudLightWrapper((
    SpotifyBrightnessWrapper(ChristmasLightProvider())), 25, 50, atBeginning=True, cloud_color=[0, 255, 0])
rightProvider = CloudLightWrapper((
    SpotifyBrightnessWrapper(FrameSkipWrapper(ChristmasLightProvider()))), 25, 50, atBeginning=True, cloud_color=[0, 255, 0])
